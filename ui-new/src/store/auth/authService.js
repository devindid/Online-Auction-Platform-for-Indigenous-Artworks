...
const login = async (user) => {
    ...
    console.log({data: response.data.data, type: response.data.data.user.userType});

    let user_ = response.data.data.user;
    let type = user_.role? user_.role : user_.userType;
