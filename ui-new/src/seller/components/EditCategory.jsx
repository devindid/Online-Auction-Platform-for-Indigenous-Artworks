          ...
          {imgUrl ? (
            ...
            >
              <img
                src={imgUrl}
                alt="upload img"
                className="w-100 h-100 rounded border border-light p-2 object-contain"
              />
              <div className="position-absolute top-0 start-0 w-100 h-100 bg-black bg-opacity-50 d-flex align-items-center justify-content-center opacity-0 hover:opacity-100 transition-opacity">
            ...
            <div
              onClick={() => imgRef.current.click()}
              className="w-100 h-100 rounded border border-dashed border-light d-flex align-items-center justify-content-center cursor-pointer"
            >
