      ...
      <div className="text-white bg-dark p-4">
        <ul className="nav flex-column font-weight-medium">
          <li className="nav-item">
            <Link
              className={`nav-link d-flex align-items-center gap-2 py-2 px-3 rounded cursor-pointer transition-all ${
                activeLink === "/admin/dashboard" ? "bg-primary text-white" : "text-light"
              }`}
              to="/admin/dashboard"
          ...
          <li className="nav-item">
            <Link
              className={`nav-link d-flex align-items-center gap-2 py-2 px-3 rounded cursor-pointer transition-all ${
                activeLink === "/admin/users" ? "bg-primary text-white" : "text-light"
              }`}
              to="/admin/users"
          ...
          <li className="nav-item">
            <Link
              className={`nav-link d-flex align-items-center gap-2 py-2 px-3 rounded cursor-pointer transition-all ${
                activeLink === "/admin/auctions" ? "bg-primary text-white" : "text-light"
              }`}
              to="/admin/auctions"
          ...
          <li className="nav-item">
            <Link
              className={`nav-link d-flex align-items-center gap-2 py-2 px-3 rounded cursor-pointer transition-all ${
                activeLink === "/admin/categories" ? "bg-primary text-white" : "text-light"
              }`}
              to="/admin/categories"
