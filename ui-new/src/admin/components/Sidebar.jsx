      ...
      <div className="bg-dark text-white p-4 rounded-3">
        <ul className="nav flex-column">
          <li className="nav-item">
            <Link
              className={`nav-link d-flex align-items-center gap-2 py-2 px-3 rounded ${
                activeLink === "/admin/users" ? "bg-primary text-white" : "text-white"
              }`}
              to="/admin/users"
            ...
            >
              <FaUser
                ...
                className={`text-white ${
                  activeLink === "/admin/users" ? "text-white" : "text-primary"
                }`}
              />
              Users
            </Link>
          ...
          <li className="nav-item">
            <Link
              className={`nav-link d-flex align-items-center gap-2 py-2 px-3 rounded ${
                activeLink === "/admin/auctions" ? "bg-primary text-white" : "text-white"
              }`}
              to="/admin/auctions"
            ...
            >
              <RiAuctionFill
                size={16}
                className={`text-white ${
                  activeLink === "/admin/auctions" ? "text-white" : "text-primary"
                }`}
              />
              Auctions
            </Link>
          ...
          <li className="nav-item">
            <Link
              className={`nav-link d-flex align-items-center gap-2 py-2 px-3 rounded ${
                activeLink === "/admin/categories" ? "bg-primary text-white" : "text-white"
              }`}
              to="/admin/categories"
            ...
            >
              <BiSolidCategory
                size={18}
                className={`text-white ${
                  activeLink === "/admin/categories" ? "text-white" : "text-primary"
                }`}
              />
              Category
            </Link>
          ...
          <li className="nav-item">
            <Link
              className="nav-link d-flex align-items-center gap-2 py-2 px-3 rounded text-white"
