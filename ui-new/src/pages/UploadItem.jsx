...
const UploadItem = () => {
  ...
  return (
    <div className="container my-4">
      <form
        className="d-flex flex-column flex-lg-row gap-4 justify-center mx-auto px-4 py-5"
        onSubmit={handleProductUpload}
      >
        <div className="text-white col-lg-3 col-md-6">
          <h1 className="text-white fs-3 fw-bold mb-4">Upload Item</h1>
          ...
          {imgUrl ? (
            <img
              ...
              className="w-100 h-100 rounded border-2 border-solid p-2 object-contain cursor-pointer"
            />
          ) : (
            <div
              onClick={() => imgRef.current.click()}
