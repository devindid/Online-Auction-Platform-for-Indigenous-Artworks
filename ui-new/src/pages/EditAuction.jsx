...
const EditAuction = () => {
  ...
  return (
    <div>
      <form
        className="d-flex flex-column flex-lg-row gap-4 justify-content-center w-100 px-4 py-5"
        onSubmit={handleProductUpload}
      >
        <div className="text-white w-100 w-lg-25 mb-4">
          <h1 className="text-white h2 font-bold mb-4">Upload Item</h1>
          ...
          {imgUrl ? (
            <img
              ...
              className="w-100 h-auto rounded-lg border border-info p-2 object-contain cursor-pointer"
            />
          ) : (
            <div
              onClick={() => imgRef.current.click()}
              className="w-100 h-100 rounded-lg border border-dashed border-info d-flex align-items-center justify-content-center cursor-pointer"
            >
        ...
        <div className="flex flex-col gap-4 w-100 w-lg-50 p-4">
          {/* Product Name */}
          <div className="mb-4">
            <label htmlFor="product_name" className="form-label text-white">
              Product Name
            </label>
            <input
              required
          ...
          <div className="row mb-4">
            <div className="col-lg-6">
              <label htmlFor="startTime" className="form-label text-white">
                Start Time
              </label>
              <input
                required
            ...
            <div className="col-lg-6">
              <label htmlFor="endTime" className="form-label text-white">
                End Time
              </label>
              <input
                required
          ...
          {/* Starting Price and Location */}
          <div className="row mb-4">
            <div className="col-lg-6">
              <label htmlFor="starting_price" className="form-label text-white">
                Starting Price
              </label>
              <input
                required
