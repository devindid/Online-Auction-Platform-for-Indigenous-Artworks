...
const SearchLocationCategory = () => {
  ...
  return (
    <div className="d-flex justify-content-center align-items-center my-5" style={{ minHeight: "100px" }}>
      <div className="d-flex flex-column flex-sm-row align-items-sm-center bg-dark text-secondary rounded p-2">
    
  
        <select
          required
          id="category"
          className="form-select bg-dark text-secondary mb-2 mb-sm-0 ms-sm-3"
        ...
        <input
          ...
          className="form-control bg-dark text-secondary ms-sm-3 mb-2 mb-sm-0"
